document.addEventListener('DOMContentLoaded', () => {
  ...
  const candyColors = [
    'url(../resimler/red-candy.png)',
    'url(../resimler/yellow-candy.png)',
    'url(../resimler/orange-candy.png)',
    'url(../resimler/purple-candy.png)',
    'url(../resimler/green-candy.png)',
    'url(../resimler/blue-candy.png)'
  ]
